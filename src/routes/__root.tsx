  ...
  head: () => ({
    meta: [
      ...
      { title: "PaceLab — Running coaching, week by week" },
      {
        name: "description",
        content:
          "Coach-led running platform: athletes log in to their plan, coaches publish and update every training week.",
      },
      { property: "og:title", content: "PaceLab — Running coaching, week by week" },
      {
        property: "og:description",
        content: "Athlete logins, weekly training plans and session logs in one place.",
      },
